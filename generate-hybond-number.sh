...
echo "29 
37" > group.txt
g_hbond_g_d -f ../../md_0_1000.xtc -s ../../md_0_1000.tpr -n index.ndx -num BA_chol_dppc.xvg -dt 20000 < group.txt

echo "31 
37" > group.txt
g_hbond_g_d -f ../../md_0_1000.xtc -s ../../md_0_1000.tpr -n index.ndx -num BC_chol_dppc.xvg -dt 20000 < group.txt

echo "29 
34" > group.txt
g_hbond_g_d -f ../../md_0_1000.xtc -s ../../md_0_1000.tpr -n index.ndx -num BA_chol.xvg -dt 20000 < group.txt

echo "31 
34" > group.txt
g_hbond_g_d -f ../../md_0_1000.xtc -s ../../md_0_1000.tpr -n index.ndx -num BC_chol.xvg -dt 20000 < group.txt

echo "29 
36" > group.txt
g_hbond_g_d -f ../../md_0_1000.xtc -s ../../md_0_1000.tpr -n index.ndx -num BA_dppc.xvg -dt 20000 < group.txt

echo "31 
36" > group.txt
g_hbond_g_d -f ../../md_0_1000.xtc -s ../../md_0_1000.tpr -n index.ndx -num BC_dppc.xvg -dt 20000 < group.txt
