...
# ############################################
export PATH=/opt/intel/composerxe-2011.2.137/bin/intel64:/usr/local/mpi/intel/bin:/usr/local/fftw/bin:/usr/local/gromacs/bin:i${PATH}
...
# ################################
/usr/local/mpi/intel/bin/mpirun -np $NCPUS -machinefile $PBS_NODEFILE mdrun_mpi_d -deffnm md_0_1000 -cpi md_0_1000.cpt -append -dd 0 0 0 -dlb yes
